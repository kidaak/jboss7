...
<html:form action="/services/submitEntityQuestionnaireIndividualRenewLicenseFunction">
...
<c:import url="/pages/dynamicContent.jsp">
    <c:param name="page" value="SubmitQuestionnaireEntityRenewal_01.jsp" />
</c:import>
</div>
...
<logic:iterate name="renewLicenseFormBean" property="entityQuestions" id="entityQuestions" indexId="index">
<!-- ========================================================================= -->
<tr class="question_row">
    <td class="question_row" nowrap>
            <html:radio name="entityQuestions" property="answer" indexed="true" value="Yes" styleId="<%= \"Yes\" + index %>" />&nbsp;<label for="Yes<%= index %>">Yes</label>&nbsp;
            <html:radio name="entityQuestions" property="answer" indexed="true" value="No" styleId="<%= \"No\" + index %>" />&nbsp;<label for="No<%= index %>">No</label>
    </td>
    <td class="question_row" nowrap>&nbsp;&nbsp;</td>
    <td class="question_row"  valign="bottom" width="100%"><div class="dreInstructionDyn"><bean:write name="entityQuestions" property="questionText" /></div></td>
</tr>
<!-- ========================================================================= -->
</logic:iterate>
