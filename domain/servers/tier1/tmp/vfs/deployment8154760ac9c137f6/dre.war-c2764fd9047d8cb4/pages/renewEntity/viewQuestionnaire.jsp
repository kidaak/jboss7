...
<html:form action="/services/submitQuestionnaireEntityRenewalFunction">
...
<logic:iterate name="entityRenewalFormBean" property="entityQuestions" id="entityQuestions" indexId="index">
<!-- ========================================================================= -->
<tr class="question_row">
