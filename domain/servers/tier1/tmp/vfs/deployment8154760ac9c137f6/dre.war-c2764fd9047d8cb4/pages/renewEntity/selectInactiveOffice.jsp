...
<html:form action="/services/selectInactiveOfficeEntityRenewalFunction">
    ...
    <c:if test="${!empty entityRenewalFormBean.inactiveOfficeList}">
        ...
        <table class="data_table" cellspacing="1">
            ...
            <logic:iterate id="inactiveOfficeList" name="entityRenewalFormBean" property="inactiveOfficeList">
