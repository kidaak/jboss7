...
<body topmargin="0" bottommargin="0" leftmargin="0" rightmargin="0" marginwidth="0" marginheight="0" background="htdocs/images/bg_header.gif" bgcolor="#FFFFFF"
    onLoad="javascript:<tiles:getAsString name="param.onLoad" ignore="true"/>;"
>
