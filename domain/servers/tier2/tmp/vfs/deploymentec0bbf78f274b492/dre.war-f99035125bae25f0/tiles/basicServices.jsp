...
<a class="<c:out value="${alternator.currentString}"/>" href="<c:url value="/index.do" />"><bean:message key='nav.home'/></a>
</c:if>
<c:if test="${!empty userInfo}">
...
<td class="<c:out value="${alternator.nextString}"/>">&nbsp;</td>
<td class="<c:out value="${alternator.currentString}"/>" colspan=2>
<a class="<c:out value="${alternator.currentString}"/>" href="<util:propertyMgr key="DREHome" defaultValue="http://www.re.state.az.us/" />"><bean:message key='nav.gotodre'/></a>
</td>
</tr>
...
<td class="<c:out value="${alternator.nextString}"/>">&nbsp;</td>
<td class="<c:out value="${alternator.currentString}"/>" colspan=2>
<a class="<c:out value="${alternator.currentString}"/>" href="<util:propertyMgr key="PortalHome"/>"><bean:message key='nav.gotoaays'/></a>
</td>
</tr>
