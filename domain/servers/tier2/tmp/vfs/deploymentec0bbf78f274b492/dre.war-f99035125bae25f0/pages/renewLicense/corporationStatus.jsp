...
<html:form action="/services/submitCorporationStatusIndividualRenewLicenseFunction" method="post">
...
<c:import url="/pages/dynamicContent.jsp">
    <c:param name="page" value="SubmitIndividualCorporationStatusIndividualRenewal_01.jsp" />
</c:import>
</div>
...
<table cellpadding="0" cellspacing="1" border="0">
    <tr>
        <td align="right" valign="top" nowrap>
            <html:checkbox property="continueCorporationStatus" value="Y" styleId="status" />
        </td>
        <td nowrap>&nbsp;&nbsp;</td>
        <td valign="bottom">
            <div class="dreInstructionConfig">
                <label for="status">
                    <c:import url="/pages/dynamicContent.jsp">
                        <c:param name="page" value="SubmitIndividualCorporationStatusIndividualRenewal_02.jsp" />
                    </c:import>
                </label>
            </div>
        </td>
