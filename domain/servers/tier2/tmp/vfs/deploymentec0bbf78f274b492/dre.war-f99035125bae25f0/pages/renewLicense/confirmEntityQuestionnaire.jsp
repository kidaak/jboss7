...
<html:form action="/services/confirmEntityQuestionnaireIndividualLicenseRenewFunction">
...
<c:forEach var="question" items="${renewLicenseFormBean.entityQuestions}" varStatus="status">
<!-- ========================================================================= -->
<tr class="question_row">
