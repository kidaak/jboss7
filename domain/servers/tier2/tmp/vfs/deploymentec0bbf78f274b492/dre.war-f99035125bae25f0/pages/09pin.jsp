...
<c:import url="/pages/dynamicContent.jsp">
    <c:param name="page" value="09pin_01.jsp" />
</c:import>
</div>

<html:form action="/submitRequiredInfoPin">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
        ...
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td><img src="htdocs/images/spacer.gif" width="10" height="10" alt=""></td>
                <td nowrap align="right" valign="top"><label for="name"><bean:message key="common.label.pin" /><bean:message key='common.label.sep'/></label>&nbsp;&nbsp;
                </td>
                <td><html:text property="pin" size="20" styleId="name" /></td>
            </tr>
            <tr>
