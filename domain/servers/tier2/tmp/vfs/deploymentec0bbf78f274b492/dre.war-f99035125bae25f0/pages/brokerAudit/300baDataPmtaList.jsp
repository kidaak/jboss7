...
<c:import url="/pages/dynamicContent.jsp">
    <c:param name="page" value="300baDataPmtaList_01.jsp" />
</c:import>
</div>


<html:form action="/audit/300baDataPmtaList">
    <html:hidden property="page" value="300"/>
    ...
    <table class="data_table2" cellspacing="1" summary="list of all status">
        <tr>
         ...
         <logic:iterate name="brokerAuditFormBean" property="propMgmtTrustAccounts" id="propMgmtTrustAccounts">
         <tr>
            <td class="data" nowrap><html:text name="propMgmtTrustAccounts" property="title" size="22" maxlength="40" indexed="true"/></td>
            <td class="data" nowrap><html:text name="propMgmtTrustAccounts" property="institutionName" size="25" maxlength="30" indexed="true"/></td>
            <td class="data" nowrap><html:text name="propMgmtTrustAccounts" property="institutionAddress" size="48" maxlength="50" indexed="true"/></td>
            <td class="data" nowrap><html:text name="propMgmtTrustAccounts" property="accountNumber" size="10" maxlength="20" indexed="true"/></td>
         </tr>
         </logic:iterate>
        <!-- ========================================================================= -->
         <tr>
