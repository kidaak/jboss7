...
<html:form action="/services/confirmQuestionnaireRenewLicenseFunction">
...
<c:import url="/pages/dynamicContent.jsp">
    <c:param name="page" value="VerifyQuestionnaire_01.jsp" />
</c:import>
</div>
...
<c:forEach var="question" items="${renewLicenseFormBean.questions}" varStatus="status">
<!-- ========================================================================= -->
<tr class="question_row">
...
<tr class="question_row" valign="top">
    <td class="question_row" align="right" nowrap><html:checkbox property="certify" value="Y" styleId="cb" /></td>
    <td class="question_row" nowrap>&nbsp;&nbsp;</td>
    <td class="question_row"  valign="bottom" >
        <div class="dreInstructionConfig">
            <label for="cb">
            <c:import url="/pages/dynamicContent.jsp">
                <c:param name="page" value="VerifyQuestionnaire_02.jsp" />
            </c:import>
            </label>
        </div>
    </td>
